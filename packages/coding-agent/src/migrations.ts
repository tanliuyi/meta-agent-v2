...
/**
 * Migrate sessions from ~/.pi-desk/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.pi-desk/agent/ instead of
 * ~/.pi-desk/agent/sessions/<encoded-cwd>/. This migration moves them
