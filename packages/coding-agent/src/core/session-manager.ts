 ...
 * Encodes cwd into a safe directory name under ~/.pi-desk/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.pi-desk/agent/sessions/<encoded-cwd>/).
	 */
