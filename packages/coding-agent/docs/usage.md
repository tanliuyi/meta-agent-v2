...
Sessions are saved automatically to `~/.pi-desk/agent/sessions/`, organized by working directory.
...
- `~/.pi-desk/agent/AGENTS.md` for global instructions
...
- `.pi-desk/SYSTEM.md` for a project
- `~/.pi-desk/agent/SYSTEM.md` globally
