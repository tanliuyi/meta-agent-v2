...
Discovery rules:
- In `~/.pi-desk/agent/skills/` and `.pi-desk/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.pi-desk/settings.json`:
