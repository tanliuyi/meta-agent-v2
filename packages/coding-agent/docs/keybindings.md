...
All keyboard shortcuts can be customized via `~/.pi-desk/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.pi-desk/agent/keybindings.json`:
