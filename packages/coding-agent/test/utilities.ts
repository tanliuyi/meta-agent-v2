...
// ============================================================================
// OAuth API key resolution from ~/.pi-desk/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".pi-desk", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.pi-desk/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.pi-desk/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".pi-desk", "agent");

/**
 * Get an AuthStorage instance backed by ~/.pi-desk/agent/auth.json
