...
import type { QuestionAnswer, QuestionData, QuestionnaireResult, QuestionParams } from "./tool/types";
 ...
 */
export type DialogOptions = { signal?: AbortSignal };

export type DialogUI = {
	select: (title: string, options: string[], dialogOptions?: DialogOptions) => Promise<string | undefined>;
	input: (title: string, placeholder?: string, dialogOptions?: DialogOptions) => Promise<string | undefined>;
};
