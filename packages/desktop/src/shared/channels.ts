...
export const CHANNELS = {
  ...
  gitDiffUntracked: "desktop:git:diff-untracked",
  gitStage: "desktop:git:stage",
  gitUnstage: "desktop:git:unstage",
  gitDiscard: "desktop:git:discard",
  gitApplyHunk: "desktop:git:apply-hunk",
  gitCommit: "desktop:git:commit",
  gitWatch: "desktop:git:watch",
  gitUnwatch: "desktop:git:unwatch",
  gitStatusChanged: "desktop:git:status-changed",
