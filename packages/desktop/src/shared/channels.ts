...
export const CHANNELS = {
  ...
  filesGetDocxEditorSource: "desktop:files:get-docx-editor-source",
  filesSaveDocxEditor: "desktop:files:save-docx-editor",
  filesInspectOfficeDocument: "desktop:files:inspect-office-document",
  filesPlanOfficeDocument: "desktop:files:plan-office-document",
  filesDiscardOfficeDocumentPlan: "desktop:files:discard-office-document-plan",
  filesCommitOfficeDocument: "desktop:files:commit-office-document",
  filesCancelOfficeDocumentPreview: "desktop:files:cancel-office-document-preview",
  filesOfficeDocumentPlanCreated: "desktop:files:office-document-plan-created",
