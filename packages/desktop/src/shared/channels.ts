...
export const CHANNELS = {
  ...
  codexPluginsList: "desktop:codex-plugins:list",
  codexPluginsInstall: "desktop:codex-plugins:install",
  codexPluginsUpdate: "desktop:codex-plugins:update",
  codexPluginsUninstall: "desktop:codex-plugins:uninstall",
  codexPluginsSetEnabled: "desktop:codex-plugins:set-enabled",
