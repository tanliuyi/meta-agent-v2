...
import { disposeChildSessions, setChildSessionFactory, type ChildSessionFactory } from "../runs/shared/child-session.ts";
...
export default function registerSubagentExtension(pi: ExtensionAPI, childSessionFactory?: ChildSessionFactory): void {
	...
	if (childSessionFactory) setChildSessionFactory(childSessionFactory);
