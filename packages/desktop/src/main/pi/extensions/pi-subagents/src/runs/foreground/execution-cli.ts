...
import { getPiSpawnCommand, getPiSpawnEnvironment } from "../shared/pi-spawn.ts";
...
async function runSingleAttempt(
	...
	const spawnEnv = getPiSpawnEnvironment(spawnSpec.command, { ...process.env, ...sharedEnv, ...getSubagentDepthEnv(options.maxSubagentDepth) });
