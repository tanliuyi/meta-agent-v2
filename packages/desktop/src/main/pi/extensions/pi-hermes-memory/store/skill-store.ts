 ...
 *
 * Global skills live in ~/.pi-desk/agent/pi-hermes-memory/skills/<slug>/SKILL.md.
 * Project skills live in ~/.pi-desk/agent/<projectsMemoryDir>/<project>/skills/<slug>/SKILL.md.
 */
