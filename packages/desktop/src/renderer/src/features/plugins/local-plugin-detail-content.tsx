    ...
    <>
      <div className="plugin-marketplace-detail-header">
        <div className="plugin-marketplace-detail-identity">
          ...
          <div>
            <strong className="plugin-local-detail-name">{plugin.displayName}</strong>
      ...
      <div className="plugin-marketplace-detail-body">
        <div className="plugin-marketplace-detail-badges" aria-label="插件状态">
          <span className="plugin-marketplace-badge" data-tone={plugin.configuredEnabled ? "ok" : "muted"}>
        ...
        <section className="plugin-marketplace-detail-section" aria-labelledby="plugin-local-detail-configuration">
          <h3 id="plugin-local-detail-configuration">配置</h3>
      ...
      <DialogFooter className="plugin-marketplace-detail-footer">
        {confirmingRemove ? (
          <div className="plugin-marketplace-detail-confirmation" role="group" aria-label="移除本地插件">
            <div>
              <strong>移除 {plugin.displayName}？</strong>
