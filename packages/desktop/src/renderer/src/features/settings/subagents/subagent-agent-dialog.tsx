...
export function SubagentAgentDialog({
  ...
  async function submit(event: FormEvent<HTMLFormElement>): Promise<void> {
    ...
    if (!builtin && (!current.name.trim() || !current.description.trim())) {
      setActiveTab("basic");
  ...
  return (
    <Dialog open onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="subagent-editor-dialog subagent-agent-dialog w-[min(65rem,calc(100vw-32px))] max-w-none gap-0 p-0">
        ...
        <form
          id="subagent-agent-form"
          className="subagent-editor-form subagent-agent-form"
          onSubmit={(event) => void submit(event)}
        >
          <Tabs value={activeTab} className="subagent-editor-tabs" onValueChange={setActiveTab}>
            <TabsList className="subagent-editor-tab-list" aria-label="智能体配置分类">
              <TabsTrigger value="basic">基本信息</TabsTrigger>
              <TabsTrigger value="model">模型与提示</TabsTrigger>
              <TabsTrigger value="capabilities">能力</TabsTrigger>
              <TabsTrigger value="limits">执行限制</TabsTrigger>
            </TabsList>

            <TabsContent value="basic" className="subagent-editor-tab-content">
            ...
            <TabsContent value="model" className="subagent-editor-tab-content">
              <SubagentModelField
            ...
            <TabsContent value="capabilities" className="subagent-editor-tab-content">
