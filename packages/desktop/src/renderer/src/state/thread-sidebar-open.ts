...
import type { WorkbenchSessionTab } from "./workbench-tab-context.tsx";
 ...
 */
export function openThreadAsSidebarTab(deps: OpenThreadSidebarDeps, thread: ThreadSidebarTarget): void {
