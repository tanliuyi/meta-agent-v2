...
const desktopApi: DesktopApi = {
  ...
  codexPlugins: {
    list: () => ipcRenderer.invoke(CHANNELS.codexPluginsList),
    install: (input) => ipcRenderer.invoke(CHANNELS.codexPluginsInstall, input),
    update: (input) => ipcRenderer.invoke(CHANNELS.codexPluginsUpdate, input),
    uninstall: (input) => ipcRenderer.invoke(CHANNELS.codexPluginsUninstall, input),
    setEnabled: (input) => ipcRenderer.invoke(CHANNELS.codexPluginsSetEnabled, input),
  },
  subagents: {
