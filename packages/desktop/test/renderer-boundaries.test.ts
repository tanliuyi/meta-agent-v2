...
function cssSystemFiles(overrides: Readonly<Record<string, string>> = {}): Readonly<Record<string, string>> {
  return {
    ...
    "styles/index.css": [
      ...
      '@import "./auto-title-settings.css" layer(components);',
      ...
      '@import "./browser-panel.css" layer(components);',
      '@import "./browser-settings.css" layer(components);',
    ...
    "styles/memory-settings.css": ".memory { color: hsl(var(--foreground)); }",
    "styles/auto-title-settings.css": ".auto-title { color: hsl(var(--foreground)); }",
    ...
    "styles/browser-settings.css": ".browser-settings { color: hsl(var(--foreground)); }",
