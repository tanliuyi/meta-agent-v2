...
| Agent settings（项目） | `<project>/.pi/agent/settings.json` 的 `subagents.agentOverrides` 部分 | 内置 agent override（项目级） |
| 自定义 agent 目录（用户） | `~/.pi/agent/agents/*.md` | 自定义 agent 定义 |
| 自定义 agent 目录（项目） | `<project>/.pi/agent/agents/*.md` | 自定义 agent 定义 |
| Chain 目录（用户） | `~/.pi/agent/chains/*.chain.md` | Chain 定义 |
| Chain 目录（项目） | `<project>/.pi/agent/chains/*.chain.md` | Chain 定义 |
